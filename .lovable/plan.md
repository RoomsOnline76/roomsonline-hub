...
4. **Confirm the counts** after the run: Fonteinhutte 9 active units = 9 matched live listings, and the account total moves from 26 to 27 live listings with the orphan list unchanged.
