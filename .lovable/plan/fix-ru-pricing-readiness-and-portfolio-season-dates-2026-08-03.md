...
3. **Keep portfolio season dates synchronized automatically**
  ...
  - to clarify: calender defines the seasons and they are echoed in the seasons tab. since the calendar has the season editor, the seasons tab is not really needed for ROLOS PMS properties. All is in the cladner /seasons tab including rates. Rack and other fallback rates are configured in rates tab. But claender seasons and rates are primary
