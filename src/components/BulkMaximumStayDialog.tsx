...
export function BulkMaximumStayDialog({ open, onOpenChange }: BulkMaximumStayDialogProps) {
  const [selectedRoomTypes, setSelectedRoomTypes] = useState<string[]>([]);
  const [fromDate, setFromDate] = useState("2025-11-19");
  const [toDate, setToDate] = useState("2025-11-26");
  const [maximumStay, setMaximumStay] = useState("0");
              ...
              <div className="col-span-9 space-y-6">
                <div className="border rounded-lg p-6 space-y-4">
                  <div className="space-y-2">
                    <Label>Change maximum stay to</Label>
