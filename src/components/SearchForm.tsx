      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-background border-b border-border shadow-lg">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center gap-4">
            ...
            <div ref={formRef} className="flex-1 relative">
              <form onSubmit={handleSearch} className="bg-card rounded-full shadow-md border border-border px-3 py-2 flex items-center gap-2">
