...
export function ChannelSyncObservabilityPanel() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Endpoint progress tracker — push + pull across the whole implementation */}
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button variant="ghost" onClick={() => void load()} className="ml-auto">
      ...
      {/* Channel-eligible properties — held ones stay listed for manual ramp-up */}
      <Card>
        <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <Popover open={addOpen} onOpenChange={setAddOpen}>
              <PopoverTrigger asChild>
                <Button variant="outline" size="icon" aria-label="Add property to the distribution board">
              ...
              <PopoverContent className="w-72 p-0" align="end">
                <Command>
                  ...
                  <CommandList>
                    ...
                    <CommandGroup heading="Add to the board">
                      {addableProperties.map((p) => (
                        <CommandItem
                          ...
                          onSelect={() => {
                            ...
                            setAddOpen(false);
                            toast.success(`${p.name} added — enable distribution when ready`);
                          }}
                        >
                          {p.name}
                        </CommandItem>
                ...
                <TableRow key={p.id} className={p.ru_push_enabled ? undefined : "opacity-70"}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <Switch checked={!!p.ru_push_enabled} onCheckedChange={(v) => void togglePush(p.id, v)} />
                  ...
                  return (
                    <TableRow key={r.id} className="cursor-pointer" onClick={() => setSelected(r)}>
                      ...
                      <TableCell className="text-xs text-muted-foreground truncate max-w-[240px]">
                        {normalizeRuSyncError(r.error_message) ?? "—"}
                      </TableCell>
                    </TableRow>
                  );
                })}
