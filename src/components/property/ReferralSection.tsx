...
const STATUS_COLORS: Record<string, string> = {
  pending: "bg-warning-surface text-warning dark:bg-yellow-900/30 dark:text-yellow-400",
  qualified: "bg-info-surface text-info dark:bg-blue-900/30 dark:text-blue-400",
  converted: "bg-success-surface text-success dark:bg-green-900/30 dark:text-green-400",
  churned: "bg-danger-surface text-destructive dark:bg-red-900/30 dark:text-red-400",
};
