...
const insightsSection: NavSection = {
  ...
  items: [
    { id: "property-pulse", title: "Property Pulse", icon: BarChart3, href: "/dashboard/reports", minRole: "owner" },
    {
      ...
      href: "/admin/account",
      minRole: "owner",
      description: "Billing, invoices, payouts & statements",
    },
...

    {
      ...
      minRole: "admin",
      description: "Distribution spend forecast & listing archive",
    },
...
const adminSection: NavSection = {
  ...
  items: [
    ...
    },
    {
      ...
      minRole: "admin",
      description: "Property acquisition team",
    },
    // Finance
    { id: "payments", title: "Payments", icon: CreditCard, href: "/admin/payments", minRole: "admin" },
    {
      ...
      icon: CreditCard,
      href: "/admin/billing-defaults",
      minRole: "dev",
      description: "Global billing strategy rates",
    },
    {
      ...
      minRole: "admin",
      description: "Monthly commission approvals",
    },
  ],
};
  ...
  items: [
    {
      ...
      minRole: "dev",
      description: "Overview, components & maintenance",
    },
    {
      id: "pms-control",
      title: "PMS Control",
      ...
      href: "/dev/pms",
      minRole: "dev",
      description: "Adapter status & controls",
    },
    {
      id: "integrations",
      title: "Integrations",
      ...
      href: "/admin-keys",
      minRole: "admin",
      description: "API keys, PMS credentials & external tools",
    },
    {
      id: "data-logs",
      title: "Data & Logs",
    ...
    { id: "feature-flags", title: "Feature Flags", icon: Flag, href: "/dev/features", minRole: "dev" },
    {
      ...
      href: "/dev/tasks",
      minRole: "dev",
      description: "Dev task board",
    },
    {
      id: "api-configurator",
      title: "API Configurator",
      icon: Code2,
      href: "/admin/system/api-configurator",
      minRole: "dev",
      description: "UI config for WP plugin & embeds",
    },

    {
      ...
      href: "/docs/api",
      minRole: "dev",
      description: "OpenAPI specification viewer",
    },
  ],
};
