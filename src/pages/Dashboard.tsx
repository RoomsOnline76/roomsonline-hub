...
const Dashboard = () => {
  ...
  // PMS Distribution and Property Growth Stats (admin only)
  ...
  return (
    <AppLayout>
      <PageHeader
        title="Property Acquisition & PMS Distribution"
      ...
      <div className="flex flex-wrap items-center gap-2 mb-4">
        ...
        {/* Property Acquisition & PMS Distribution - Admin/Dev Only */}
        {isAdmin && pmsStats && (
          <Collapsible open={pmsExpanded} onOpenChange={setPmsExpanded} className="mb-3">
            <Card className="p-2">
