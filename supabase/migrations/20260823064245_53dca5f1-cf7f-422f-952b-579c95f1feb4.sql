...
BEGIN
  ...
  -- outbound push: the 30-minute reservations poll rewrites rooms and notes on every pass, which
  -- generated an endless moved/notes -> acceptance echo loop. The recency guard now covers every
  -- change kind, acceptance included.
  SELECT EXISTS (
